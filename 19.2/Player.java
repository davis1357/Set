...
//        }
    ...
    public void point() {
        ...
        //     long pointTime = currentTime + env.config.pointFreezeMillis;
        //     while(pointTime-currentTime==0)
        //     {
    ...
    public void penalty() {
        ...
        for(int i=0;i<3;i++)
        {
            ...
            // long currentTime = System.currentTimeMillis();
            // long penlatyTime = currentTime + env.config.penaltyFreezeMillis;
            // env.ui.setFreeze(id, env.config.penaltyFreezeMillis);
            // while(penlatyTime-currentTime>0)
            // {
            //     currentTime = System.currentTimeMillis();
            //     env.ui.setFreeze(id, penlatyTime-currentTime);
            // }
            // env.ui.setFreeze(id, 0);
