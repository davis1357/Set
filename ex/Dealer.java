...
public class Dealer implements Runnable {
    ...
    private void updateTimerDisplay(boolean reset) {
        ...
        if(reset || reshuffleTime == Long.MAX_VALUE){
            env.ui.setCountdown(/*env.config.turnTimeoutMillis*/ 6 *1000,false);
            reshuffleTime =  currentTime + /*env.config.turnTimeoutMillis*/ 6 *1000;
    ...
    private void removeAllCardsFromTable() {
        ...
        for(Player playerush : players){
            searchAndRemoveTokens(playerush);
        }
        ...
        reshuffleTime = System.currentTimeMillis() + /*env.config.turnTimeoutMillis*/ 6 *1000 + 1000;
    }
